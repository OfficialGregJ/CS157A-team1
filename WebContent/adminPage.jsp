        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-blue-100 p-4 rounded-lg">
                    ...
                    <p class="text-2xl font-bold">50</p> <!-- Replace with dynamic count -->
                </div>
                <div class="bg-green-100 p-4 rounded-lg">
                    <h3 class="font-semibold mb-2">Total Players</h3>
                    <p class="text-2xl font-bold">120</p> <!-- Replace with dynamic count -->
                </div>
                <div class="bg-yellow-100 p-4 rounded-lg">
                    <h3 class="font-semibold mb-2">Total Tournaments</h3>
                    <p class="text-2xl font-bold">10</p> <!-- Replace with dynamic count -->
                </div>
            </div>
        </section>
